...
CREATE TABLE IF NOT EXISTS UPSTREAM_REGISTRY_ACCESS_CONFIG (
  REGISTRY_ID TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS UPSTREAM_REGISTRY_STORAGE_CONFIG (
  REGISTRY_ID TEXT NOT NULL,
  STORAGE_LIMIT REAL DEFAULT 100 CHECK(STORAGE_LIMIT >= 100),
  CLEANUP_POLICY TEXT NOT NULL DEFAULT 'lru_1m' CHECK(CLEANUP_POLICY IN ('lru_1m', 'lru_3m', 'lp')),
...
CREATE TABLE IF NOT EXISTS UPSTREAM_REGISTRY_CACHE_CONFIG (
  REGISTRY_ID TEXT NOT NULL,
  ENABLED INTEGER NOT NULL DEFAULT 0 CHECK(ENABLED IN (0, 1)),
  TTL_SECONDS INTEGER NOT NULL DEFAULT 2592000 CHECK(TTL_SECONDS BETWEEN 600 AND 31536000),
